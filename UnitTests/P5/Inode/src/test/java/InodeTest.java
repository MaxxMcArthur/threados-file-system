...
/**
 * Unit tests for the Inode class.
 * 
 * Tests the functionality of the Inode implementation including:
 * - Inode creation and initialization
 * - Direct and indirect block management
...
public class InodeTest {
    ...
    public void testPrintDefault() {
        ...
        assertTrue(output.contains("  Flag: 0"));
